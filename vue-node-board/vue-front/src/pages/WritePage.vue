  ...
  <v-app>
    <v-app-bar app color="red" dark>
      <v-app-bar-title style="margin-inline-start: 0;">
        <div :style="{textAlign: 'center', fontSize:'xx-large'}">게시판 {{ $route.params.id }} 글쓰기</div>
      </v-app-bar-title>
    </v-app-bar>
    <v-main>
      <v-container>
          ...
          <v-col cols="12" md="10">
            <v-card>
              <v-form ref="form" @submit.prevent="onSubmitForm">
                <v-text-field v-model="writer" dense outlined label="작성자" style="width: 300px; margin-left: 100px; padding-top: 20px;" :rules="[v => !!v || '작성자는 필수입니다.']"></v-text-field>
                <v-text-field v-model="title" dense outlined label="제목" style="width: 500px; margin-left: 100px; padding-top: 20px;" :rules="[v => !!v || '제목은 필수입니다.']"></v-text-field>
